  ...
  <section class="timeline-container timeline">
    <div @click="changeCurrentTimePoint(point)" v-for="point in points" class="timeline-block">
      ...
      <div class="timeline-content">
        <div class="f09 mb02" v-text="point.title"></div>
        <div class="f07 f-color-grey" v-text="point.text"></div>
        ...
        ></a>
        <span v-if="point.date" class="f06 f-color-grey" v-text="point.date"></span>
      </div>
    </div>
  </section>
</template>
